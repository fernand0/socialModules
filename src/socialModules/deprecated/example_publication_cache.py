...
def demo_basic_usage():
    ...
    history = cache.get_publications_by_original_link(
        "https://myblog.com/python-beginners"
    )
...
def demo_search_and_management():
    ...
    articles = [
        (
            ...
            "https://blog.com/docker-tutorial",
            "twitter",
        ),
        ("Introduction to Kubernetes", "https://blog.com/kubernetes-intro", "facebook"),
        (
            "Docker vs Kubernetes: Which to choose?",
            "https://blog.com/docker-vs-kubernetes",
            "linkedin",
        ),
        (
            "Container guide with Docker",
            "https://blog.com/containers-docker",
            "twitter",
        ),
    ]
