...
class modulePocket(Content):  # ,Queue):
    ...
    def setApiPosts(self):
        posts = []
        try:
            dictPosts = self.client.retrieve(state="unread", sort="new")
...
def main():
    ...
    if testingSlack:
        ...
        for key in rules.rules.keys():
            if (key[0] == "pocket") and (key[2] == "fernand0kobo"):
    ...
    try:
        ...
        logging.info(f"Creation of the directory {PATH} failed. " f"It exists")
