...
class Publisher:
    ...
    def showPost(self, args):
        ...
        if self.isForMe(args):
            j = int(args[-1])
            serviceName = (
                "Cache_" + self.socialNetwork[0] + "_" + self.socialNetwork[1]
            ...
            (
                ...
                links,
                comment,
            ) = self.postsFormatted[serviceName]["pending"][j]
            if title:
                return title + " " + link
            else:
                return ""
    ...
    def publishPost(self, args):
        ...
        if self.isForMe(args):
            ...
            (
                ...
                links,
                comment,
            ) = self.content.getPostsFormatted[serviceName]["pending"][j]
            publishMethod = getattr(
                moduleSocial, "publish" + self.socialNetwork[0].capitalize()
            )
            ...
            if not isinstance(update, str) or (
                ...
                self.postsFormatted[serviceName]["pending"] = (
                    self.postsFormatted[serviceName]["pending"][:j]
                    + self.postsFormatted[serviceName]["pending"][j + 1 :]
                )
