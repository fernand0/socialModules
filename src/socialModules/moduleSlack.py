...
'https://www.diariodeteruel.es/entrevistas/ruben-catalan-cocinero-del-restaurante-el-visco-que-ha-recibido-una-estrella-verde-michelin-lo-que-necesita-el-matarrana-es-tener-continuidad-en-el-turismo-todo-el-ano',
...
'https://historiatelefonia.com/2022/11/12/coleccion-de-telefonos-singulares-en-arganzuela-madrid/',
                ]
        apiSrc.setChannel('links')
        for link in links:
