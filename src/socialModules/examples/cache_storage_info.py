...
def check_storage_permissions():
    ...
    checks = [
        ...
        ("Cache directory writable", os.access(cache_dir, os.W_OK) if os.path.exists(cache_dir) else False),
        ("Cache file exists", os.path.exists(cache_file)),
        ("Cache file readable", os.access(cache_file, os.R_OK) if os.path.exists(cache_file) else True),
        ("Cache file writable", os.access(cache_file, os.W_OK) if os.path.exists(cache_file) else True)
    ]
