...
class moduleWordpress(Content, Queue):
    ...
    def authorize(self):
        ...
        param = self.api_auth.format(client_id, urllib.parse.quote(redirect_uri), url)
        print(
            "Paste this URL in your browser and allow the application: {}{}".format(
                self.oauth_base, param
            )
        )
